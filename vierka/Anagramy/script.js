...
function getXML(){
    ...
    xhttp.open('GET', 'anagramy.xml', false);
...
//___________________________________________koniec anagramov___(daj skore do cookies)___________________
    ...
    countAnagrams++;
    console.log(tempAnagrams, countAnagrams);
}
...
function checkAnagram(){
    ...
    for (var i = 0; i <= ries.length -1; i++) {
        ...
        else {document.getElementById("chyba").innerHTML = "spravne, pokracuj na dalsi";
